...
# Form implementation generated from reading ui file '/home/adming/python/python_notas_e_moedas_colecao-1/layout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(1000, 921))
        ...
        self.frame_cadastro.setMinimumSize(QtCore.QSize(600, 0))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.frame_cadastro.setFont(font)
        ...
        self.frame_cadastro.setLineWidth(2)
...
"color: rgb(170, 23, 25);")
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.bt_deletar_reg.setFont(font)
        ...
        self.gridLayout.addLayout(self.horizontalLayout, 18, 0, 1, 5)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_conservacao.setFont(font)
        self.ed_conservacao.setObjectName("ed_conservacao")
        self.gridLayout.addWidget(self.ed_conservacao, 12, 3, 1, 1)
        self.ed_anverso = QtWidgets.QLineEdit(self.frame_cadastro)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_anverso.setFont(font)
        self.ed_anverso.setObjectName("ed_anverso")
        self.gridLayout.addWidget(self.ed_anverso, 11, 1, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_assunto.setFont(font)
        self.ed_assunto.setObjectName("ed_assunto")
        self.gridLayout.addWidget(self.ed_assunto, 5, 1, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_peso.setFont(font)
        self.ed_peso.setObjectName("ed_peso")
        self.gridLayout.addWidget(self.ed_peso, 9, 1, 1, 1)
        self.ed_serie = QtWidgets.QLineEdit(self.frame_cadastro)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_serie.setFont(font)
        self.ed_serie.setObjectName("ed_serie")
        self.gridLayout.addWidget(self.ed_serie, 6, 3, 1, 1)
        self.ed_borda = QtWidgets.QLineEdit(self.frame_cadastro)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_borda.setFont(font)
        self.ed_borda.setObjectName("ed_borda")
        self.gridLayout.addWidget(self.ed_borda, 8, 3, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_krause.setFont(font)
        self.ed_krause.setObjectName("ed_krause")
        self.gridLayout.addWidget(self.ed_krause, 3, 1, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_diametro.setFont(font)
        self.ed_diametro.setObjectName("ed_diametro")
        self.gridLayout.addWidget(self.ed_diametro, 10, 1, 1, 1)
        self.ed_periodo = QtWidgets.QLineEdit(self.frame_cadastro)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_periodo.setFont(font)
        self.ed_periodo.setObjectName("ed_periodo")
        self.gridLayout.addWidget(self.ed_periodo, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_data, 13, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_23, 13, 0, 1, 2)
        self.ed_circulacao = QtWidgets.QLineEdit(self.frame_cadastro)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_circulacao.setFont(font)
        self.ed_circulacao.setObjectName("ed_circulacao")
        self.gridLayout.addWidget(self.ed_circulacao, 5, 3, 1, 1)
        self.label_15 = QtWidgets.QLabel(self.frame_cadastro)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_15.setFont(font)
        self.label_15.setObjectName("label_15")
        self.gridLayout.addWidget(self.label_15, 15, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.foto_reverso, 14, 3, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_formato.setFont(font)
        self.ed_formato.setObjectName("ed_formato")
        self.gridLayout.addWidget(self.ed_formato, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_status_cadastro, 19, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.ed_ano, 2, 3, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_venda.setFont(font)
        self.ed_venda.setObjectName("ed_venda")
        self.gridLayout.addWidget(self.ed_venda, 12, 1, 1, 1)
        self.conservacao = QtWidgets.QLabel(self.frame_cadastro)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.conservacao.setFont(font)
        self.conservacao.setObjectName("conservacao")
        self.gridLayout.addWidget(self.conservacao, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.foto_anverso, 14, 1, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_reverso.setFont(font)
        self.ed_reverso.setObjectName("ed_reverso")
        self.gridLayout.addWidget(self.ed_reverso, 11, 3, 1, 1)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.ed_localizar.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(9)
        self.bt_localizar.setFont(font)
        ...
        self.gridLayout_7.addLayout(self.gridLayout_2, 8, 0, 1, 1)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.bt_moedabr = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.bt_moedabr.setFont(font)
        self.bt_moedabr.setObjectName("bt_moedabr")
        self.horizontalLayout_3.addWidget(self.bt_moedabr)
        self.bt_moedaint = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.bt_moedaint.setFont(font)
        self.bt_moedaint.setObjectName("bt_moedaint")
        self.horizontalLayout_3.addWidget(self.bt_moedaint)
        self.bt_notabr = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.bt_notabr.setFont(font)
        self.bt_notabr.setObjectName("bt_notabr")
        self.horizontalLayout_3.addWidget(self.bt_notabr)
        self.bt_notaint = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.bt_notaint.setFont(font)
        self.bt_notaint.setObjectName("bt_notaint")
        self.horizontalLayout_3.addWidget(self.bt_notaint)
        self.bt_colecao = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.bt_colecao.setFont(font)
        self.bt_colecao.setObjectName("bt_colecao")
        self.horizontalLayout_3.addWidget(self.bt_colecao)
        self.bt_pais = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.bt_pais.setFont(font)
        self.bt_pais.setObjectName("bt_pais")
        self.horizontalLayout_3.addWidget(self.bt_pais)
        self.bt_novidade = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.bt_novidade.setFont(font)
        self.bt_novidade.setObjectName("bt_novidade")
        self.horizontalLayout_3.addWidget(self.bt_novidade)
        ...
        self.actionGerar_Backup.setVisible(False)
        ...
        MainWindow.setTabOrder(self.ed_diametro, self.ed_espessura)
        MainWindow.setTabOrder(self.ed_espessura, self.ed_anverso)
        MainWindow.setTabOrder(self.ed_anverso, self.ed_reverso)
        MainWindow.setTabOrder(self.ed_reverso, self.ed_venda)
        MainWindow.setTabOrder(self.ed_venda, self.ed_conservacao)
        MainWindow.setTabOrder(self.ed_conservacao, self.ed_foto1)
        MainWindow.setTabOrder(self.ed_foto1, self.ed_foto2)
        MainWindow.setTabOrder(self.ed_foto2, self.bt_mostrar_foto)
        MainWindow.setTabOrder(self.bt_mostrar_foto, self.bt_cadastrar)
        MainWindow.setTabOrder(self.bt_cadastrar, self.bt_deletar_reg)
        MainWindow.setTabOrder(self.bt_deletar_reg, self.bt_cancelar)
        MainWindow.setTabOrder(self.bt_cancelar, self.ed_localizar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Coleção de Moedas e Notas 2023"))
        ...
        self.bt_scrap.setText(_translate("MainWindow", "Capturar dados da Ucoin.com"))
        ...
        self.bt_moedabr.setText(_translate("MainWindow", "Moedas Brasil"))
        self.bt_moedaint.setText(_translate("MainWindow", "Moedas Int."))
        self.bt_notabr.setText(_translate("MainWindow", "Notas Brasil"))
        self.bt_notaint.setText(_translate("MainWindow", "Notas Int."))
        self.bt_colecao.setText(_translate("MainWindow", "Coleção"))
        self.bt_pais.setText(_translate("MainWindow", "Por País"))
        self.bt_novidade.setText(_translate("MainWindow", "Novidades"))
        ...
        self.Exportar_TXT.setText(_translate("MainWindow", "Fazer Backup"))
