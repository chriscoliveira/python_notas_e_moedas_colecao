...
class DBase:
    ...
    def cadastrar(self, venda, cunhagem, foto1, foto2, cadastro, pais, ano, krause, valor, periodo, circulacao, assunto, serie, soberano, composicao, borda, formato, alinhamento, peso, diametro, espessura, anverso, reverso, conservacao):
        # print(venda, cunhagem, foto1, foto2, cadastro, pais, ano, krause, valor, periodo, circulacao, assunto, serie,
        #       soberano, composicao, borda, formato, alinhamento, peso, diametro, espessura, anverso, reverso, sep='\n')
...
def captura_dados_moeda(link):
    ...
    for i in linhasinfo:
        ...
        if 'Conservação' in str(i):
            ...
            try:
                CONSERVACAO = soupinfo.find('div', class_='wrap').text
            except:
                CONSERVACAO = ''
...
for i in range(26, 111):
    captura_itens_pagina(link_colecao+str(i))

# captura_itens_pagina(link_colecao+'1')
# captura_dados_moeda(
    # 'https://pt.ucoin.net/coin/spain-10-centimos-1941/?ucid=50926539')
# login_site()
