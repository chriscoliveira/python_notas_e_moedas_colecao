...
# Form implementation generated from reading ui file 'c:\Users\Christian\Python Projects\Github\python_notas_e_moedas_colecao\new_layout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_notas = QtWidgets.QPushButton(self.centralwidget)
        self.bt_notas.setObjectName("bt_notas")
        self.horizontalLayout_3.addWidget(self.bt_notas)
        self.bt_moedas = QtWidgets.QPushButton(self.centralwidget)
        self.bt_moedas.setObjectName("bt_moedas")
        self.horizontalLayout_3.addWidget(self.bt_moedas)
        ...
        self.bt_recentes = QtWidgets.QPushButton(self.centralwidget)
        self.bt_recentes.setObjectName("bt_recentes")
        self.horizontalLayout_3.addWidget(self.bt_recentes)
        self.bt_cadastro = QtWidgets.QPushButton(self.centralwidget)
        self.bt_cadastro.setObjectName("bt_cadastro")
        self.horizontalLayout_3.addWidget(self.bt_cadastro)
...
"color: rgb(170, 23, 25);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_notas.setText(_translate("MainWindow", "Notas"))
        self.bt_moedas.setText(_translate("MainWindow", "Moedas"))
        self.bt_colecao.setText(_translate("MainWindow", "Colecao"))
        self.bt_recentes.setText(_translate("MainWindow", "Recentes"))
        self.bt_cadastro.setText(_translate("MainWindow", "Cadastrar"))
